  ...
  return (
    <div >
        <button onClick={()=> refreshImages(images)}
            className='fixed bottom-10 right-10 bg-violet-400/90 text-white px-5
            py-3 rounded-md hover:via-violet-500 focus:outline-none focus:ring-2
        ...
        <div className='grid gap-4 sm:grid-cols-1 md:grid-cols-2 lg:grid-col-3 xl:grid-cols-4
